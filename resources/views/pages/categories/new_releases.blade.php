...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (applyPriceRangeBtn && minPriceInput && maxPriceInput) {
    ...
    const performFilter = () => {
        ...
        if (!loadingSpinner || !booksGridContainer || !currentCountSpan || !totalCountSpan) {
        ...
        // Make AJAX request
        fetch(`/api/categories/new-releases/filter?${params.toString()}`, {
            method: 'GET',
            headers: {
