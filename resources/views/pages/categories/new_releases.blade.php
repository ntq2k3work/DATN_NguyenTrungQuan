...
<section class="py-8 sm:py-12 lg:py-16 bg-background">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-8 sm:mb-12">
            <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-3 sm:mb-4">Sách mới phát hành</h1>
                ...
                <div class="p-3 sm:p-4">
                    <div class="relative mb-3 sm:mb-4">
                        ...
                        <div class="absolute top-2 left-2 flex flex-col gap-2">
                            <span class="bg-secondary text-secondary-foreground px-2 py-1 text-xs rounded">Mới</span>
                        </div>
                        <button
                    ...
                    <div class="space-y-2 sm:space-y-3">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <span class="text-base sm:text-lg font-bold text-primary text-orange-500">{{ number_format($book->final_price ?? $book->price, 0, ',', '.') }}đ</span>
                        ...
                        <button class="w-full px-3 sm:px-4 py-2 rounded bg-amber-600 text-white cursor-pointer hover:bg-amber-500 text-xs sm:text-sm">
                            Thêm vào giỏ
                        </button>
                    </div>
                </div>
