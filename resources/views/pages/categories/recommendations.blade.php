        ...
        <div class="main-content-with-sidebar flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
            ...
            <div class="flex-1">
                ...
                <div id="books-grid-container">
                    @include('partials.books-grid-recommendations', ['books' => $books])
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const performFilter = () => {
        ...
        // Make AJAX request
        fetch(`/api/categories/recommendations/filter?${params.toString()}`, {
            method: 'GET',
            headers: {
        ...
        .then(data => {
            // Update books grid
            booksGridContainer.innerHTML = data.html;
