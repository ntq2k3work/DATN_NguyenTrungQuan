...
class NewReleases extends Component
{
    ...
    public function loadNewReleases()
    {
        $this->newPublishers = Book::with(['author', 'discounts'])
            ->orderBy('created_at', 'desc')
            ->take(6)
            ->get();
        
        foreach($this->newPublishers as $book) {
            ...
            $book->final_price = number_format($book->final_price, 0, ',', '.');
        }
    }
